...
public:
  ...
  static const int ADD_TILE = 0;
  static const int ADD_OBJECT = 1;
...
//  bool m_bMouseTarget; //true if mouse cursor is target
  ...
  int m_currentGroupID;//for tiles
  int m_currentObjectGroupID;
  int m_lastObjectGroupID;
  int m_lastTileGroupID;
